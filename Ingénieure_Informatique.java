 ...
 * @author user
 */
public class Ingénieure_Informatique extends Poste{

    public Ingénieure_Informatique(int num_poste, String Nom, float nbr_heure) {
        super(num_poste, Nom, nbr_heure);
    }
       //méthodes
 //******Ajouter
    
    public void ajouter3(Employées e){ 
    ...
    //******modifier
    public Employées modifier3(int id,Employées p){
      for(int i=0; i<Employees.size();i++)
    ...
    return p;}
//*****Calculerprime
 public void CalculerPrime3( int Nbr){
